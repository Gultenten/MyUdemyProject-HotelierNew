...
namespace HotelProjectt.DataAccessLayer.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialMedai1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialMedai2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialMedai3 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
