   ...
   public class AppUserManager : IAppUserService
    {
        ...
        List<AppUser> IAppUserService.TUserListWorkLocation()
        {
            return _appUserDal.UserListWorkLocation();
        }

        List<AppUser> IAppUserService.TUserListWorkLocations()
        {
            return _appUserDal.UserListWorkLocations();
        }
    }
}
